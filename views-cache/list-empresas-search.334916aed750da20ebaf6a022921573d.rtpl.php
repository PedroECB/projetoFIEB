    ...
    <div class="col-md-12">
      <div class="box box-primary">
            ...
            <div class="box-header">
              <!--<a href="#" class="btn btn-success btn-block"> --><h4 class="text-primary"><center><b>EMPRESAS <?php echo htmlspecialchars( $origem, ENT_COMPAT, 'UTF-8', FALSE ); ?></b></center></h4> <!--</a>-->
            ...
            <div class="box-footer clearfix">
              ...
              <a href="/user/exportempresas-origem" style="color:white;"><button class="btn btn-success btn-xs"><b><i class="fa fa-th"></i> Exportar para o Excel</b></button></a>
