...
<section class="content-header">
 ...
 <a href="/user/contatos-create"><button class="btn btn-primary btn-sm" type="button"><b>NOVO CONTATO</b></button></a>
  <ol class="breadcrumb">
              ...
              <table class="table table-striped table-bordered text-center table-responsive table-hover">
                <thead>
                  <tr>
                    ...
                    <th style="width: 55px" class="orig">Telefone</th>
                    <th style="width: 100px" class="nv">Email</th>
                ...
                <tbody>
                  ...
                  <?php $counter1=-1;  if( isset($contatos) && ( is_array($contatos) || $contatos instanceof Traversable ) && sizeof($contatos) ) foreach( $contatos as $key1 => $value1 ){ $counter1++; ?>
                    <tr>
                      ...
                      <td>
                        <a href="/<?php echo htmlspecialchars( $value1["id_contatos"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/user/contatos"><button class="btn btn-default btn-xs" title="Visualizar"><i class="fa fa-eye"></i></button></a>
                        
                        <?php if( $value1["id_funcionario"] == $session["idFuncionario"] ){ ?>
                             <a href="/user/contatos/<?php echo htmlspecialchars( $value1["id_contatos"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/remove"><button class="btn btn-danger btn-xs" title="Remover"><i class="fa fa-close"></i></button></a> 
                        <?php } ?>
                      </td>
                    </tr>
                  <?php } ?>
