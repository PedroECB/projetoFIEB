    ...
    <div class="col-md-6">
      ...
      <div class="form-group">
        <label for="cIndustriasVisitadas">Indústrias Visitadas: <span class="text-danger">*</span></label>  
         <input type="number" class="form-control" id="cIndustriasVisitadas" name="industriasVisitadas" placeholder="Digite apenas números" max="10000" min="0" required>
      </div>
    ...
    <div class="col-md-6">
       <div class="form-group">
        <label for="cNovasAssoc">Novas Associações: <span class="text-danger">*</span></label>  
         <input type="number" class="form-control" id="cNovasAssoc" name="novasAssoc" placeholder="Digite apenas números" max="100000" min="0" required>
       </div>
    ...
    <div class="col-md-6">
       ...
       <div class="form-group">
        <label for="cPropostasDemandadas">Propostas Demandadas: <span class="text-danger">*</span></label>  
         <input type="number" class="form-control" id="cPropostasDemandadas" name="propostasDemandadas" placeholder="Digite apenas números" max="100000" min="0" required>
       </div>
    ...
    <div class="col-md-6">
       ...
       <div class="form-group">
        <label for="cInteresseEmAssoc">Interesse em Associar-se: <span class="text-danger">*</span></label>  
         <input type="number" class="form-control" id="cInteresseEmAssoc" name="interesseEmAssoc" placeholder="Digite apenas números" max="100000" min="0" required>
       </div>
    ...
    <div class="col-md-6">
       ...
       <div class="form-group">
        <label for="cContratosAssin">Contratos Assinados: <span class="text-danger">*</span></label>  
         <input type="number" class="form-control" id="cContratosAssin" name="contratosAssin" placeholder="Digite apenas números" max="100000" min="0" required>
       </div>
    ...
    <div class="col-md-6">
       ...
       <div class="form-group">
        <label for="cReceita">Receita: <span class="text-danger">*</span></label>  
         <input type="number" class="form-control" id="cReceita" name="receita" placeholder="R$" max="100000000000" min="0" required>
       </div>
