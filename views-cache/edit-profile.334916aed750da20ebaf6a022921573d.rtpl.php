...
<section class="content">
  ...
  <div class="row">
  	<div class="col-md-12">
        ...
        <!-- form start -->
        <form role="form" action="/user/edit-profile" method="post">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="cCargo" name="cCargo" placeholder="Ex: Agente/Executivo" value="<?php echo htmlspecialchars( $user["cargo"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" maxlength="40" required>
            </div>
