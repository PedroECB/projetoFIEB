        ...
        <form role="form" action="/admin/users/create" method="post">
          <div class="box-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="campoNome" name="nome" placeholder="Nome completo do novo usuário" readonly="" value="">
            </div>

            <div class="form-group">
              <label for="campoRG" >RG:</label>
              <input type="tel" class="form-control" id="campoRG" name="rg" placeholder="Apenas números" readonly="">
            </div>
              ...
              <select id="campoOrigem" class="form-control">
               ...
               <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="tel" id="campoTel" class="form-control" data-inputmask="'mask': ['999-999-9999 [x99999]', '+099 99 99 9999[9]-9999']" data-mask placeholder="(DDD) 7777-8888" name="telefone" readonly="" value="">
                </div>
                <!-- /.input group -->
              </div>
         ...
         <div class="form-group">
            ...
            <div class="input-group">
                <div class="input-group-addon">
                  ...
                  <input type="email" class="form-control" id="campoEmail" name="email" placeholder="email@exemplo.com" readonly="">
            </div>  
        </div>
