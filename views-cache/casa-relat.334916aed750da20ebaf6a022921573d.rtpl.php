    ...
    <div class="col-md-12">
      <div class="box box-primary">
            ...
            <div class="box-header">
              <div class="col-md-12">
              <!--<a href="#" class="btn btn-success btn-block"> --><h4 class="text-primary"><center><b><?php echo htmlspecialchars( $dadosCasa["nome_casa"], ENT_COMPAT, 'UTF-8', FALSE ); ?> - GERAL</b><a href="javascript:history.back();"><button class="btn btn-link navbar-right"><b>Voltar</b></button></a></center></h4> <!--</a>-->
              <hr></div>
