...
<section class="content-header">
  ...
  <h1>  <!--<b>CICLOS</b>-->
    <small><b>RELATÓRIOS POR CICLO</b></small>
  </h1>
  ...
  <ol class="breadcrumb">
    ...
    <button class="btn btn-xs"><li class="active"><a href="/admin/ciclos-relat/"><i class="fa fa-circle-o-notch"></i> Relatórios por Ciclos</a></li></button>
  </ol>
