    ...
    <div class="col-md-12">
      <div class="box box-primary">
            ...
            <div class="box-header">
              ...
              <div class="box-tools">
                <form action="/user2/origem/visitas">
            ...
            <div class="box-footer clearfix">
              <a href="/user2/export-visitas-origem" style="color:white;"><button class="btn btn-success btn-xs"><b><i class="fa fa-th"></i> Exportar para o Excel</b></button></a>
