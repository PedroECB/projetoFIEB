      ...
      <div class="box box-primary">
        ...
        <!-- form start -->
            ...
            <div class="box-body"> 
                  ...
                  <center>
                    ...
                    <tbody>
                      ...
                      <tr><td><b>DATA PREVISTA</b></td>                     <td><?php echo date('d/m/Y',strtotime($visita["data_prevista"])); ?></td></tr>
          ...
          <?php if( $visita["origem"] == $origem["origem"] ){ ?>
            ...
            <a href="/user/edit-visita/<?php echo htmlspecialchars( $visita["idVisita"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><button type="button" class="btn btn-primary btn-sm" style="margin-top: 5px;"><b><i class="fa fa-pencil-square"></i>&nbsp ALTERAR DADOS DA VISITA</b></button></a>  
            <?php if( !isset($visita["agente_atend"]) ){ ?>

            <a href="/user/finalize-visita/<?php echo htmlspecialchars( $visita["idVisita"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><button type="button" class="btn btn-danger btn-sm" style="margin-top: 5px;"><b><i class="fa  fa-check-square"></i>&nbsp FINALIZAR VISITA</b></button></a>
            <?php } ?>
