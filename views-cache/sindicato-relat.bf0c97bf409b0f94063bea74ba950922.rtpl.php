  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="users-create2.html"><i class="fa fa-link"></i> <span>Another Link</span></a></li>
        <li class="treeview">
    ...
    <div class="col-md-12">
      <div class="box box-primary">
            ...
            <div class="box-header">
              <div class="col-md-12">
              <!--<a href="#" class="btn btn-success btn-block"> --><h3 class="text-primary"><center><b>SINDRATAR</b></center></h3> <!--</a>-->
              </div>
            </div>
                      ...
                      <div class="col-sm-12"><br>
                        ...
                        <table class="table table-striped table-bordered   table-hover">
                          ...
                          <tbody>
                             ...
                             <tr>
                              <td><b>Empresas Selecionadas</b></td><td>7</td>  
                            </tr>

                             <tr>
                              <td><b>Empresas Associadas</b></td><td>2</td>  
                            </tr> 

                             <tr>
                              <td><b>Não Associadas</b></td><td>23</td>  
                            </tr>  
                       ...
                       <div class="col-md-6">
                        ...
                        <table class="table table-striped table-bordered   table-hover">
                          ...
                          <tbody>
                             ...
                             <tr>
                              <td><b>Agendadas</b></td><td>7</td>  
                            </tr>

                             <tr>
                              <td><b>Sem Ação</b></td><td>2</td>  
                            </tr> 

                             <tr>
                              <td><b>Sem Sucesso no Agendamento</b></td><td>23</td>  
                            </tr>

                              <tr>
                              <td><b>Empresa Desativada</b></td><td>23</td>  
                            </tr>  
                        ...
                        <table class="table table-striped table-bordered   table-hover">
                          ...
                          <tbody>
                             ...
                             <tr>
                              <td><b>Associações Efetivadas</b></td><td>2</td>  
                            </tr>

                             <tr>
                              <td><b>Associações em Negociação</b></td><td>1</td>  
                            </tr> 
