...
<section class="content-header">
  ...
  <h1>
     <small><b>SOLICITAÇÕES DE ACESSO AO SISTEMA</b></small>
  </h1>
  ...
  <ol class="breadcrumb">
    ...
    <button class="btn btn-xs"><li class="active"><a href="/admin/solicitations">Solicitações</a></li></button>
  </ol>
</section>
              ...
              <table class="table table-striped table-bordered text-center table-responsive table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="/admin/solicitations-info/<?php echo htmlspecialchars( $value1["idCadastro"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-info btn-xs">&nbsp&nbsp&nbsp&nbsp<i class="fa fa-info"></i> <b> &nbsp Info &nbsp&nbsp&nbsp</b></a>
