...
<?php $counter1=-1;  if( isset($ciclos) && ( is_array($ciclos) || $ciclos instanceof Traversable ) && sizeof($ciclos) ) foreach( $ciclos as $key1 => $value1 ){ $counter1++; ?>
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box bg-blue">
              ...
              <?php if( $tp == 'SINDICATO' ){ ?> 
                <a href="/user2/ciclo-relat-sind/<?php echo htmlspecialchars( $value1["idCiclo"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" style="color:white;" title="Relatórios do ciclo: <?php echo htmlspecialchars( $value1["nome_ciclo"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><span class="info-box-icon"><i class="fa fa-pie-chart"></i></span></a>
                <!-- /user/relatorio-sindicato/ -->
              <?php } ?>

             
             <?php if( $tp == 'CASA' ){ ?> 
               <a href="/user2/ciclo-relat-casa/<?php echo htmlspecialchars( $value1["idCiclo"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" style="color:white;" title="Relatórios do ciclo: <?php echo htmlspecialchars( $value1["nome_ciclo"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><span class="info-box-icon"><i class="fa fa-pie-chart"></i></span></a>
                <!-- /user/relatorio-casa/ -->
             <?php } ?>
