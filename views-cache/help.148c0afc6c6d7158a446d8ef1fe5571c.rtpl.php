              ...
              <div class="box-group" id="accordion">
                ...
                <div class="panel box box-primary">
                  ...
                  <div id="collapseOne" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                    <div class="box-body">
                      Para agendar uma visita a uma empresa no ciclo é necessário que a empresa esteja previamente cadastrada no sistema <a href="/user2/empresa-create" target="_blank">(clique aqui para cadastrar uma empresa)</a>. Após a realização do cadastro da empresa procure a empresa desejada para visita na lista de empresas cadastradas e clique no botão de agendar visita e preencha as informações solicitadas.
                    </div>
                  </div>
                </div>
                <div class="panel box box-primary">
              ...
              <div class="box-group" id="accordion">
                ...
                <div class="panel box box-primary">
                  ...
                  <div id="collapseSeven" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                    <div class="box-body">
                      <a href="/user2/edit-profile" target="_blank">Clique aqui para alterar suas informações de cadastro</a>
                    </div>
                  </div>
                </div>
                <div class="panel box box-primary">
                  ...
                  <div id="collapseEight" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                    <div class="box-body">
                      <a href="/user2/alter-password" target="_blank">Clique aqui para alterar sua senha</a>
                    </div>
                  </div>
                </div>
                <div class="panel box box-primary">
                  ...
                  <div id="collapseNine" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                    <div class="box-body">
                      Para alterar o nível de acesso é necessário entrar em contato com qualquer um os administradores que estão indentificados com a entidade "FIEB" na aba de <a href="/user2/contatos">contatos</a>. 
                    </div>
                  </div>
                </div>
              </div>
