   ...
   <div class="box-body"> 
          ...
          <div class="box-footer">
           <div class="col-md-12"> 
            ...
            <a href="/user/empresa/agenda-visita/#"><button type="button" class="btn btn-success btn-sm" style="margin-top: 5px;"><b><i class="fa fa-calendar"></i>&nbsp AGENDAR VISITA</b></button></a>  

            <a href="/user/empresa/#/delete"><button type="button" class="btn btn-danger btn-sm" style="margin-top: 5px;"><b><i class="fa fa-close"></i>&nbsp REMOVER EMPRESA</b></button></a>
