...
<section class="content-header">
  ...
  <h1>
     <small><b>RELATÓRIOS DO SINDICATO <?php echo htmlspecialchars( $origem, ENT_COMPAT, 'UTF-8', FALSE ); ?> NO CICLO</b></small>
  </h1>
  
  <ol class="breadcrumb">
    <button class="btn btn-xs"><li><a href="/user2"><i class="fa fa-home"></i> Início</a></li></button>
     <button class="btn btn-xs"><li class="active"><a href="/user2/ciclos-relat/"><i class="fa fa-circle-o-notch"></i> Relatórios Sindicatos</a></li></button>
  </ol>
</section>
    ...
    <div class="col-md-12">
      <div class="box box-primary">
            ...
            <div class="box-header">
              <div class="col-md-12">
              <!--<a href="#" class="btn btn-success btn-block"> --><h4 class="text-primary"><center><b><?php echo htmlspecialchars( $dadosSindicato["nome_sindicato"], ENT_COMPAT, 'UTF-8', FALSE ); ?> &nbsp<span class="text-success"><?php echo date('d/m/Y', strtotime($ciclo["data_inicio"])); ?> - <?php echo date('d/m/Y', strtotime($ciclo["data_termino"])); ?></span></b><a href="javascript:history.back();"><button class="btn btn-link navbar-right"><b>Voltar</b></button></a></center></h4> <!--</a>-->
              </div>
            </div>
