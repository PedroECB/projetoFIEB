...
<section class="content-header">
  ...
  <h1>
     <small><b>EMPRESAS CADASTRADAS NO CICLO ATUAL</b></small>
  </h1>
  
  <ol class="breadcrumb">
    <button class="btn btn-xs"><li><a href="/admin"><i class="fa fa-home"></i> Início</a></li></button>
    <button class="btn btn-xs"><li class="active"><a href="/admin/empresas"><i class="fa fa-industry"></i> Empresas geral</a></li></button>
    <button class="btn btn-xs"><li class="active"><a href="/admin/empresas-ciclo-atual"><i class="fa fa-circle-o-notch"></i> Empresas ciclo atual</a></li></button>
  </ol>
</section>
    ...
    <div class="col-md-12">
      <div class="box box-primary">
            ...
            <div class="box-header">
              <!--<a href="#" class="btn btn-success btn-block"> --><h4 class="text-primary"><center><b>EMPRESAS - CICLO ATUAL</b></center></h4> <!--</a>-->
  
              <div class="box-tools">
                <form action="/admin/empresas-ciclo-atual">
              ...
              <table class="table table-striped table-bordered text-center table-responsive table-hover">
                <thead >
                  <tr>
                   <!-- <th style="width: 120px">RG</th>-->
                    ...
                    <th style="width: 80px; vertical-align: middle;">Situação da Associação</th>
                ...
                <?php $counter1=-1;  if( isset($empresas) && ( is_array($empresas) || $empresas instanceof Traversable ) && sizeof($empresas) ) foreach( $empresas as $key1 => $value1 ){ $counter1++; ?>
                 ...
                 <tr>
                    ...
                    <td>
                      <a href="/admin/agendarvisita/<?php echo htmlspecialchars( $value1["idEmpresas"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-default btn-xs"><i class="fa fa-calendar-o"></i><b> Agendar Visita</b></a>
                      <a href="/admin/empresas/<?php echo htmlspecialchars( $value1["idEmpresas"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"  class="btn btn-primary btn-xs">&nbsp&nbsp&nbsp&nbsp&nbsp<i class="fa fa-info"></i> <b>&nbsp&nbsp&nbsp Detalhes &nbsp&nbsp&nbsp&nbsp&nbsp</b></a>
                    </td>
                  </tr>
            ...
            <div class="box-footer clearfix">
              <a href="/admin/export-empresas-cicloAtual" style="color:white;"><button class="btn btn-success btn-xs"><b><i class="fa fa-th"></i> Exportar para o Excel</b></button></a>
