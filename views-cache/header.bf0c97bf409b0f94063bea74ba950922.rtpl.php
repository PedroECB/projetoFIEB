        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Carlos Silveira</span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Carlos Silveira - Diretor Executivo
                  <small>Diretor Executivo da FIEB</small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
    ...
    <section class="sidebar">
     ...
     <li class="treeview">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/admin/users"><i class="fa fa-sort-alpha-asc"></i>Listar</a></li>
