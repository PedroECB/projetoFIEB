...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/user2/empresas">Agendar Visita</a></li>
...
<div class="row">
  <div class="col-md-6">
     <form role="form" action="/user2/agendarvisita/<?php echo htmlspecialchars( $empresa["idEmpresas"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post" id="formEmpresa">
