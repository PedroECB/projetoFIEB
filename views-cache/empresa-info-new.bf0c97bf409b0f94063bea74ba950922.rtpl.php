...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <button class="btn btn-xs"><li><a href="/admin/empresas">Empresas</a></li></button>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" action="/admin/empresas-create" method="post" id="formEmpresa">
          <div class="box-body">
   ...
   <div class="box-body"> 
          ...
          <div class="box-footer">
           <div class="col-md-12"> 
            ...
            <a href="/admin/agendarvisita/<?php echo htmlspecialchars( $empresa["idEmpresas"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><button type="button" class="btn btn-success btn-sm" style="margin-top: 5px;"><b><i class="fa fa-calendar"></i>&nbsp AGENDAR VISITA</b></button></a>  

            <?php if( $empresa["origem_cadastro"] == $origem["origem"] ){ ?>

            <a href="/admin/empresa/<?php echo htmlspecialchars( $empresa["idEmpresas"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/delete"><button onclick="return confirm('Deseja realmente remover essa empresa do sistema?');" type="button" class="btn btn-danger btn-sm" style="margin-top: 5px;"><b><i class="fa fa-close"></i>&nbsp REMOVER EMPRESA</b></button></a>
            
            <a href="/admin/empresa-edit/<?php echo htmlspecialchars( $empresa["idEmpresas"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><button type="button" class="btn btn-primary btn-sm" style="margin-top: 5px;"><b><i class="fa fa-pencil-square-o"></i>&nbsp EDITAR</b></button></a>
            <?php } ?>
