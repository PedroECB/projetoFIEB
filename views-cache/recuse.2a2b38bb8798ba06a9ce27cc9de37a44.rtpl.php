            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title">Solicitacao de Acesso Recusada</td>
                    </tr>
                  </table>
                  <table class="body">
                    <tr>
                        ...
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                              Sua solicitacao de acesso ao Sistema de Gestao Articulada foi recusada por um dos administradores, realize um novo cadastro atentando-se aos dados digitados ou entre em contato com um ponto focal de sua origem.  
                            </td>
                            
                          </tr>
                          <td class="body-text-cell">Obrigado!</td>
                        </table>
                        <center>
                        <br><!--[if mso]>
