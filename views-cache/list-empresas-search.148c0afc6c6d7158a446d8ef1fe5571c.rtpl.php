...
<section class="content-header">
  ...
  <h1>
     <small><b>EMPRESAS CADASTRADAS <?php echo htmlspecialchars( $origem, ENT_COMPAT, 'UTF-8', FALSE ); ?></b></small>
  </h1>
    ...
    <div class="col-md-12">
      <div class="box box-primary">
            ...
            <div class="box-footer clearfix">
              ...
              <a href="/user2/exportempresas-origem" style="color:white;"><button class="btn btn-success btn-xs"><b><i class="fa fa-th"></i> Exportar para o Excel</b></button></a>
