            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title">Solicitacao de Acesso Aprovada</td>
                    </tr>
                  </table>
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        ...
                        <table class="body-text">
                          ...
                          <td class="body-text-cell">Obrigado! &nbsp &nbsp<a href="<?php echo htmlspecialchars( $link, ENT_COMPAT, 'UTF-8', FALSE ); ?>"> Acesse o sistema clicando aqui</a></td>
                        </table>
                        <center>
                        <br><!--[if mso]>
