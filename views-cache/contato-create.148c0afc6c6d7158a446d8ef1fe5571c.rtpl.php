...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <button class="btn btn-xs"><li><a href="/user2/contatos"><i class="fa fa-fax"></i> Contatos</a></li></button>
    <button class="btn btn-xs"><li class="active"><a href="/user2/contatos-create"><i class="fa fa-plus"></i> Novo contato</a></li></button>
  </ol>
</section>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" action="/user2/contatos-create" method="post">
          <div class="box-body">
