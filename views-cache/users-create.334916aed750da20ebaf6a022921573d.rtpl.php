...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <button class="btn btn-xs"><li><a href="/user/users">Usuários</a></li></button>
    <button class="btn btn-xs"><li class="active"><a href="/user/users/create">Cadastrar</a></li></button>
  </ol>
</section>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-primary">
         ...
         <?php } ?>
           ...
           <?php if( isset($sucesso["sucesso"]) ){ ?>
              ...
              <div class="alert alert-success" role="alert">
                  <center><b><?php echo htmlspecialchars( $sucesso["sucesso"], ENT_COMPAT, 'UTF-8', FALSE ); ?></b></center>
              </div>
           <?php } ?>
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" action="/user/users/create" method="post">
          <div class="box-body">
