    ...
    <div class="col-md-12">
      <div class="box box-primary">
            ...
            <div class="box-header">
              ...
              <div class="box-tools">
                <form action="/user2/empresas-ciclo-atual">
            ...
            <div class="box-footer clearfix">
              ...
              <a href="/user2/export-empresas-origem-cicloAtual" style="color:white;"><button class="btn btn-success btn-xs"><b><i class="fa fa-th"></i> Exportar para o Excel</b></button></a>
