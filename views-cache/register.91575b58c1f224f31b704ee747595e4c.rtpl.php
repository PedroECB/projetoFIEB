  ...
  <div class="register-box-body">
    ...
    <form id="register" action="" method="post">
      ...
      <div class="form-group has-feedback">
        ...
        <input type="tel" class="form-control" placeholder="Digite apenas números" maxlength="15" name="campoRG" id="campoRG" onblur="validaRG();" required value="<?php if( isset($dados["campoRG"]) ){ ?><?php echo htmlspecialchars( $dados["campoRG"], ENT_COMPAT, 'UTF-8', FALSE ); ?><?php } ?>">
