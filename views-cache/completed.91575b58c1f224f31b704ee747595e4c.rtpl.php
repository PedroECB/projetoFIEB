...
<div class="lockscreen-wrapper">
  <div class="lockscreen-logo">
    <a href="/login"><img src="../res/site/dist/img/LOGO01BRANCO.png" height="" class="img-responsive"></img></a>
  </div>
  ...
  <div class="help-block text-center">
    <div class="callout callout-success">
      ...
      <p>O acesso ao sistema será liberado após a aprovação do cadastro por um dos administradores</p>
    </div>
  </div>
