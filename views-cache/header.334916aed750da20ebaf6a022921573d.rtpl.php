...
<head>
  ...
  <!-- Bootstrap 3.3.6 -->
  <link rel="stylesheet" href="../../res/user/bootstrap/css/bootstrap.min.css">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.5.0/css/font-awesome.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ionicons/2.0.1/css/ionicons.min.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="../../res/user/dist/css/AdminLTE.min.css">
...
<div class="wrapper">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            <!-- Menu toggle button -->
            <a href="/user/solicitations" class="sdropdown-toggle" data-toggle="sdropdown" title="<?php echo htmlspecialchars( $qnt, ENT_COMPAT, 'UTF-8', FALSE ); ?> Solicitações pendentes">
          ...
          <li class="dropdown notifications-menu">
            ...
            <a href="/user/demandas" class="sdropdown-toggle" data-toggle="sdropdown" title="Demandas">
              <i class="fa  fa-flag"></i>
             <?php if( $qntD>0 ){ ?> <span class="label label-danger"><?php echo htmlspecialchars( $qntD, ENT_COMPAT, 'UTF-8', FALSE ); ?></span><?php } ?>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="/user/edit-profile" class="btn btn-default btn-flat">Editar Perfil</a>
                </div>
      ...
      <ul class="sidebar-menu">
       ...
       <!--  <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="/user/origem/visitas"><i class="fa fa fa-dot-circle-o"></i>Visitas <?php echo htmlspecialchars( $origem, ENT_COMPAT, 'UTF-8', FALSE ); ?></a></li>
  ...
  <li class="treeview">
        ...
        <!--<li><a href="#"><i class="fa fa-info"></i> <span>Informações</span></a></li>-->
          ...
          <ul class="treeview-menu">
            <li><a href="/user/users/create"><i class="fa fa-user-plus"></i>Cadastrar usuário</a></li>
          </ul>
        </li>
     

        <li><a href="/user/contatos"><i class="fa fa-fax"></i> <span>Contatos</span></a></li>
        <li><a href="/user/help"><i class="fa fa-question-circle"></i> <span>Dúvidas Frequentes</span></a></li>
